	...
	function (model, id, description) {
		var entry = _elm_lang$core$List$head(
			A2(
				...
				function (e) {
					return _elm_lang$core$Native_Utils.eq(e.id, id);
				},
				model.entries));
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				...
				selectedEntry: function () {
					var _p0 = {ctor: '_Tuple2', _0: entry, _1: model.selectedEntry};
					if (((_p0.ctor === '_Tuple2') && (_p0._0.ctor === 'Just')) && (_p0._1.ctor === 'Just')) {
						var _p1 = _p0._1._0;
						return _elm_lang$core$Native_Utils.eq(_p0._0._0.id, _p1.id) ? _elm_lang$core$Maybe$Just(
							_elm_lang$core$Native_Utils.update(
								_p1,
								{description: description})) : _elm_lang$core$Maybe$Just(_p1);
					} else {
...
var _user$project$Decide$removeEntry = F2(
	function (model, id) {
		var _p2 = function () {
			...
			if (_p3.ctor === 'Nothing') {
				return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: -1};
			} else {
				var _p4 = _p3._0;
				return _elm_lang$core$Native_Utils.eq(_p4.id, id) ? {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: -1} : {
					ctor: '_Tuple2',
		...
		var selectedEntry = _p2._0;
		var selectedId = _p2._1;
		...
		return _elm_lang$core$List$isEmpty(model.entries) ? _elm_lang$core$Native_Utils.update(
			model,
			{uid: 0}) : model;
	});
...
var _user$project$Decide$setStorage = _elm_lang$core$Native_Platform.outgoingPort(
	...
	function (v) {
		return {
			...
			selectedEntry: (v.selectedEntry.ctor === 'Nothing') ? null : {description: v.selectedEntry._0.description, editing: v.selectedEntry._0.editing, id: v.selectedEntry._0.id},
...
var _user$project$Decide$update = F2(
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'AddEntry':
				return _elm_lang$core$Basics$not(
					_elm_lang$core$String$isEmpty(model.field)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
			...
			case 'ToggleEditing':
				...
				var _p9 = _p5._0;
				var focus = function () {
					var task = _elm_lang$core$Native_Utils.eq(_p10, true) ? _elm_lang$dom$Dom$focus(
						_elm_lang$core$Basics$toString(_p9)) : _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
					return A3(
				...
				var updateEntry = function (e) {
					return _elm_lang$core$Native_Utils.eq(e.id, _p9) ? _elm_lang$core$Native_Utils.update(
						e,
						{editing: _p10}) : e;
				};
				var isNotEmpty = function () {
					var _p8 = _elm_lang$core$List$head(
						A2(
							_elm_lang$core$List$filter,
							function (e) {
								return _elm_lang$core$Native_Utils.eq(e.id, _p9);
							},
							model.entries));
					if (_p8.ctor === 'Nothing') {
						return false;
						...
						return _elm_lang$core$Basics$not(
							_elm_lang$core$String$isEmpty(_p8._0.description));
					}
				}();
				return isNotEmpty ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
			...
			case 'ToggleEditingSelected':
				var _p15 = _p5._0;
				var focus = function () {
					var task = _elm_lang$core$Native_Utils.eq(_p15, true) ? _elm_lang$dom$Dom$focus('selected') : _elm_lang$core$Task$succeed(
						{ctor: '_Tuple0'});
					return A3(
						_elm_lang$core$Task$perform,
						function (_p11) {
				...
				var entry = _elm_lang$core$List$head(
					A2(
						_elm_lang$core$List$filter,
						function (e) {
							return _elm_lang$core$Native_Utils.eq(e.id, model.selectedId);
						},
						model.entries));
				var _p13 = {ctor: '_Tuple2', _0: entry, _1: model.selectedEntry};
				if (((_p13.ctor === '_Tuple2') && (_p13._0.ctor === 'Just')) && (_p13._1.ctor === 'Just')) {
					var _p14 = _p13._1._0;
					return _elm_lang$core$Basics$not(
						_elm_lang$core$String$isEmpty(_p14.description)) ? A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								selectedEntry: _elm_lang$core$Maybe$Just(
									_elm_lang$core$Native_Utils.update(
										_p14,
										{editing: _p15}))
							}),
				...
				return {
					...
					_1: A2(
						...
						A2(
							...
							0,
							_elm_lang$core$List$length(model.entries) - 1))
				};
			case 'NewRandom':
				var selectedEntry = _elm_lang$core$List$head(
					A2(_elm_lang$core$List$drop, _p5._0, model.entries));
				var selectedId = function () {
					var _p17 = selectedEntry;
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{selectedEntry: selectedEntry, selectedId: selectedId}),
					_elm_lang$core$Native_List.fromArray(
						[]));
			default:
				return A2(
	...
	var _p19 = function () {
		...
		if (_p20.ctor === 'Nothing') {
			...
			return {
				...
				_0: _p21,
				_1: 'block',
				_2: _elm_lang$html$Html$text(_p21.description)
			};
		}
	}();
	var entry = _p19._0;
	var display = _p19._1;
	var innerText = _p19._2;
	return A2(
							...
							function (field) {
								return A2(
									...
									function (selectedEntry) {
										return A2(
											_elm_lang$core$Json_Decode$andThen,
											A2(_elm_lang$core$Json_Decode_ops[':='], 'selectedId', _elm_lang$core$Json_Decode$int),
											function (selectedId) {
												return A2(
													_elm_lang$core$Json_Decode$andThen,
													...
													function (uid) {
														return _elm_lang$core$Json_Decode$succeed(
															{entries: entries, field: field, selectedEntry: selectedEntry, selectedId: selectedId, uid: uid});
													});
											});
									});
							});
